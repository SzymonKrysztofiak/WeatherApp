...
const Weather = props => (
    <div className="results-container">
        {props.icon && props.city && props.country && <p><strong>Location: </strong>{props.city}, {props.country} <img className="results-icon" src={`https://openweathermap.org/img/w/${props.icon}.png`} /></p>}
